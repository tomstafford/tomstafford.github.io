...
::: {.callout-tip title="Signal collapse"}
If you write to me, please consider that I now receive an abundance of messages which appear to be well written and well researched inquiries by people who have spent a lot of time reading my website and reviewing my research interests. If you would like me to respond please consider how I might distinguish, [under the conditions of signal collapse engendered by AI](https://tomstafford.substack.com/p/when-trusted-signals-collapse), your message from all these others.
:::

From 2026 to 2028 I am a Visiting Professor in the Department of Computer Science and Technology, University of Cambridge.

As Senior Fellow and Director of Strategy at the [Research on Research Institute](https://researchonresearch.org/), I lead several projects, including the[AFIRE: Accelerator For Innovation &amp; Research Funding Experimentation](https://researchonresearch.org/project/a-f-i-r-e/). We seek to catalyse the generation and use of high quality evidence on research processes ("Metaresearch").

I am on the [PsyArXiv](https://osf.io/preprints/psyarxiv) Scientific Advisory Board as member (and ex-chair) of the Public Engagement Subcommittee. 

Previously, I was Director for the MSc programmes in Psychological Research Methods, and set up the MSc in Psychological Research Methods with Data Science. You can read more about the flagshiop module I designed and taught here: [PSY6422 Data Analysis and Visualisation](https://tomstafford.github.io/psy6422/).

From 2020 to 2025 I held the Research Practice Lead for the University of Sheffield, an institution-wide role with a remit to encourage practices which support robust and trusted research. As Research Practice Lead, I represented the University of Sheffield in the [UK Reproducibility Network](https://www.ukrn.org/), for which I chaired the national [UKRN Institutional Leads group](https://www.ukrn.org/institutional-leads/) 2023 - 2025.
...
#| echo: false
#| output: asis
txt <- paste(readLines("llms.txt", warn = FALSE), collapse = "\n")
cat('<div class="agent-note"><pre>',
